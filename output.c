...
output_prefix()
{
    ...
    fprintf(code_file, "#define Parser %sParser\n",symbol_prefix );
}
...
output_rule_data()
{
    ...
    fprintf(output_file, "static const short %slhs[] = {%42d,", "yy",
    ...
    fprintf(output_file, "static const short %slen[] = {%42d,", "yy", 2);
...
output_yydefred()
{
    ...
    fprintf(output_file, "static const short %sdefred[] = {%39d,", "yy",
...
goto_actions()
{
    ...
    fprintf(output_file, "static const short %sdgoto[] = {%40d,", "yy", k);
...
output_base()
{
    ...
    fprintf(output_file, "static const short %ssindex[] = {%39d,", "yy", base[0]);
    ...
    if (!rflag) outline += 2;
    fprintf(output_file, "\n};\nstatic const short %srindex[] = {%39d,", "yy",
	    base[nstates]);
    ...
    if (!rflag) outline += 2;
    fprintf(output_file, "\n};\nstatic const short %sgindex[] = {%39d,", "yy",
	    base[2*nstates]);
...
output_table()
{
    ...
    fprintf(output_file, "static const short %stable[] = {%40d,", "yy",
	    table[0]);
...
output_check()
{
    ...
    fprintf(output_file, "static const short %scheck[] = {%40d,", "yy",
	    check[0]);
...
output_defines()
{
    register int c, i;
    register char *s;
    fprintf(code_file,"#include \"%s.tab.h\"\n",file_prefix);
...
fprintf(defines_file,"class %sParser{\n",symbol_prefix);
